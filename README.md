...
> - Prova a usare `dromi` e poi la versione installata, ad esempio per la 1.0.3 usa `dromi103` (Funziona negli installer della 1.0.2+)
...
###### Ultima Versione
👉 [Scarica l'ultima versione - Windows 64 Bit](https://github.com/DeMENIGECO/Dromi/releases/download/1.0.1/dromi_installer_64bit_windows_1.0.1.exe)
