...
- [Linguaggi usati](#linguaggi-usati)
- [Cos'è la versione non compilata?](#cose-la-versione-non-compilata)
- [README Completo](#readme-completo)
...
La versione non compilata è sempre Dromi, ma non in bytes. Potrete vedere i files orignali che sono il "dietro delle quinte" dei `.exe`s e della cartella [`_internal`](https://github.com/DeMENIGECO/Dromi/tree/main/_internal) 

---

## README Completo

👉 https://github.com/DeMENIGECO/Dromi/blob/main/README.md
